...
export default function CampaignAveeno() {
  const campaign = getCampaignById('aveeno');
          ...
          <div className="bg-white rounded-lg border p-6">
            ...
            <div className="space-y-3">
              ...
              <div className="flex justify-between text-sm">
                <span className="text-muted-foreground">Online: {campaign.totalHours}h</span>
            ...
            <div className="mt-6 pt-6 border-t">
              ...
              <p className="text-xs text-muted-foreground">
                Total operational hours: {campaign.totalHours}h (22-day campaign)
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-4 text-sm">
          ...
          <div>
            ...
            <ul className="space-y-1 text-muted-foreground">
              <li>• Strong engagement with {campaign.totalUserInteractions.toLocaleString()} total machine interactions</li>
              <li>• High product interest driving {campaign.totalProductClicks.toLocaleString()} product detail clicks</li>
              <li>• {campaign.machineUptimePercent}% machine reliability (perfect uptime!)</li>
              <li>• {(campaign.totalProductsDispensed / campaignDays).toFixed(0)} products sampled daily on average</li>
              <li>• {campaignDays}-day campaign with consistent daily performance</li>
            </ul>
          </div>
        </div>
      </div>
