...
export default function CampaignBahlsen() {
  const campaign = getCampaignById('bahlsen');
        ...
        <div className="grid md:grid-cols-2 gap-4 text-sm">
          ...
          <div>
            ...
            <ul className="space-y-1 text-muted-foreground">
              <li>• Excellent engagement with {campaign.totalUserInteractions.toLocaleString()} total machine interactions</li>
              <li>• High product interest driving {campaign.totalProductClicks.toLocaleString()} detail clicks</li>
